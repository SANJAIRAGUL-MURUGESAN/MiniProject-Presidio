...
namespace RailwayReservationApp.Contexts
{
    public class RailwayReservationContext : DbContext
    {
        ...
        public DbSet<TrackReservation> TrackReservations { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Mapping Track and Track Reservation
            modelBuilder.Entity<TrackReservation>()
             .HasOne(r => r.Track)
             .WithMany(e => e.TrackReservations)
